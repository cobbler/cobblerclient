...
func TestCheckAccessNoFail(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "check-access-no-fail-req.xml", "check-access-no-fail-res.xml")
...
func TestCheckAccess(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "check-access-req.xml", "check-access-res.xml")
...
func TestGetAuthnModuleName(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "get-authn-module-name-req.xml", "get-authn-module-name-res.xml")
...
func TestLogin(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "login-req.xml", "login-res.xml")
	ok, err := c.Login()
	utils.FailOnError(t, err)
...
func TestLoginWithError(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "login-req.xml", "login-res-err.xml")
...
func TestLogout(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "logout-req.xml", "logout-res.xml")
	var expected = false
...
func TestTokenCheck(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "token-check-req.xml", "token-check-res.xml")
	var expected = false
...
func TestGetUserFromToken(t *testing.T) {
	c := cobbler_testing.CreateStubHTTPClient(t, "get-user-from-token-req.xml", "get-user-from-token-res.xml")
